...
class LoginPage:
    ...
    def check_login(self):
        ...
        if self.username_entry.get() == "admin" and self.password_entry.get() == "admin":
            self.open_banking_system()
        else:
            # Handle incorrect login
            print("Invalid login credentials")

    def open_banking_system(self):
        # Add the path to banking_system.py
        current_directory = os.path.dirname(os.path.abspath(__file__))
        banking_system_path = os.path.join(current_directory, 'F:/Decode/Banking App/banking_system.py')

        # Open banking_system.py using subprocess
        subprocess.call(['python', banking_system_path])
