...
class SecureTextTransferApp:
    ...
    def decrypt_file(self):
        ...
        try:
            ...
            # Print decrypted data and padding value for debugging
            print("Decrypted data (padded):", decrypted_data_padded)
            padding_value = decrypted_data_padded[-1]
            print("Padding value:", padding_value)

            # Remove padding manually
            decrypted_data = decrypted_data_padded[:-padding_value]
